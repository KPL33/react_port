  ...
  return (
    <section id="about">
      ...
      <div id="paragraph-box">
        ...
        <p>
          I am a graduate of <span>UCSD</span>&apos;s full-stack web development
          program and have over 23 years of experience in the industries of
          Design and Publishing. Within this portfolio, you&apos;ll find a
          showcase of projects. I am actively in pursuit of new opportunities
          and keen to engage in networking and explore potential collaborations
          with fellow developers. Should you have any inquiries about my work or
          background, please don&apos;t hesitate to reach out.
        </p>

        <h3 className="snark">Short Story Long...</h3>
        <p>
        ...
        <p>
          ...
          of my fellow employees. These cumulative experiences, empowered me to

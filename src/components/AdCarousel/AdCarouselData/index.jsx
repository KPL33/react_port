...
const AdShowcase = [
  {
    id: 0,
    title: "Activa2",
    description: "Image of Activa2 print ad",
    alt: "Zero Image",
    src: activa2,
  },
  // {
  ...
  // {
  //   id: 5,
  //   title: "DiamondD Custom Leather - print ad, version 3",
  //   description: "Image of DiamondD Custom Leather print ad, version 3",
  //   alt: "Fifth Image",
  //   src: diamondThreePrev,
  // },
  // {
  //   id: 6,
  ...
  // {
  //   id: 11,
  //   title: "FMG LinkedIn - digital ad",
  //   description: "Image of FMG LinkedIn digital ad",
  //   alt: "Eleventh Image",
  //   src: fmglinkedin,
  // },
  // {
  //   id: 12,
  //   title: "FMG Insider Tips - digital ad",
  //   description: "Image of FMG Insider Tips digital ad",
  //   alt: "Twelfth Image",
  //   src: insider,
  // },
  // {
  ...
  // {
  //   id: 14,
  //   title: "American Handgunner Website Promo - print ad",
  //   description: "Image of American Handgunner Website Promo print ad",
  ...
  // {
  //   id: 18,
  //   title: "Activa Products - print ad",
  //   description: "Image of Activa Products print ad",
  //   alt: "Eighteenth Image",
  //   src: activa,
  // },
  // {
  //   id: 19,
  //   title: "The Right Tool - print ad",
  //   description: "Image of The Right Tool print ad",
  //   alt: "Nineteenth Image",
  //   src: righttool,
  // },
  // {
  //   id: 20,
  //   title: "Ocken Acreage Bullet Catch - print ad",
  //   description: "Ocken Acreage Bullet Catch print ad",
  //   alt: "Twentieth Image",
  //   src: ocken,
  // },
  // {

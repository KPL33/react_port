        ...
        <main>
            ...
            <div className="projects">
                <a href="https://kpl33.github.io/work_day_scheduler/">
                    <div>
                        <img className="box-container" src = { scheduler } alt="Image of 'Day Scheduler App'" />
                    </div>
                </a>
                <a href="https://kpl33.github.io/pwd_gen">
                    <div>
                        <img className="box-container" src = { pwd } alt="Image of 'Random Password Generator App'" />
                    </div>
                </a>
            </div>
            <div className="projects">
                <a href="https://cryptic-everglades-02017-1b72bab49c69.herokuapp.com/">
                    <div>
                        <img className="box-container" src = { jate } alt="Image of 'Just Another Text Editor App'" />
                    </div>
                </a>
                <a href="https://kpl33.github.io/weather_dashboard/">
                    <div>
                        <img className="box-container" src = { weather } alt="Image of 'Weather Dashboard App'" />
                    </div>
                </a>
            </div>
        </main>
